...
#include <stdio.h>
#define MAXDIGITS 100 /* maxium length bignum */
...
void multiply_bignum(bignum *a, bignum *b, bignum *c) {
	bignum row; /* represent shifed row */
...
void int_to_bignum(int s, bignum *n, int index) { /* when index==0, translate s into 10-based bignum */
